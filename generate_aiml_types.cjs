const fs = require('fs');
const html = fs.readFileSync('form_aiml.html', 'utf8');
...
if (match) {
    ...
    fs.writeFileSync('fields_aiml.json', JSON.stringify(parsedFields, null, 2));
    console.log("Written fields_aiml.json");
} else {
